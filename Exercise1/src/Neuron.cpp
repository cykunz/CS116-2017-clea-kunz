...
/***************************************************/
/*	Adds a value of the spike time in order to record them all.	*/
void Neuron::addTimeValue(double const& new_time_value)
{	time_.push_back(new_time_value);
}

/*	Adds the new membrane potential to the vector corresponding.	*/
...
*/
/*	Iteration in all spike time values recorded to show them on the terminal.	*/
